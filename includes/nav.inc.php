...
<head>
  ...
  <!-- TITLE OF THE PAGE -->
  <title>PurabiyaNews | The Official News Portal | <?php echo $page_title; ?></title>
...
<body>
  ...
  <nav class="navbar">
    <div class="logo"><a href="./index.php"><img src="./assets/images/navlogo.png" /></a></div>
    ...
    <ul class="ul">
      ...
      <li><a href="http://localhost:3000/" <?php if($home) echo 'class="current"' ?>>RunRate</a></li>
      <li>
